...
I am a Ph.D. computer science student at <a href="https://www.utoronto.ca">University of Toronto</a> working with Professor [Yang Xu](http://www.cs.toronto.edu/~yangxu/index.html) in the [Computational Linguistics Group](http://www.cs.toronto.edu/compling/index.html). My research interest lies at the intersection of Cognitive Science, Natural Language Processing and Machine Learning.

In particular, my current research involves building data-driven computational models that support inference and generation of innovative language uses, including novel word compounds and syntactic compositions. My research methods draw on deep generative models, Bayesian statistics, and cognitive theories of categorization. This line of research has the potential application of constructing more human-like NLP systems for figurative language use such as metaphor and metonymy. 
